...
type PodFilter interface {
	...
	FilterPod(podMeta *over_statesinformer.PodMeta) (shouldSkip bool, msg string)
}
...
func (n *NothingPodFilter) FilterPod(podMeta *over_statesinformer.PodMeta) (bool, string) {
	return false, ""
}

type TerminatedPodFilter struct{}

func (t *TerminatedPodFilter) FilterPod(podMeta *over_statesinformer.PodMeta) (bool, string) {
...
func (a *AndPodFilter) FilterPod(podMeta *over_statesinformer.PodMeta) (bool, string) {
