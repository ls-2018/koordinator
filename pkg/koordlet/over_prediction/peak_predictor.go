...
const (
	// ProdReclaimablePredictor represents the type of a reclaimable production predictor. 可回收生产预测器。
...
func (p *podReclaimablePredictor) GetResult() (v1.ResourceList, error) {
	over_metrics.RecordNodePredictedResourceReclaimable(string(v1.ResourceCPU), over_metrics.UnitCore, p.GetPredictorName(), float64(p.reclaimable.Cpu().MilliValue())/1000)
	over_metrics.RecordNodePredictedResourceReclaimable(string(v1.ResourceMemory), over_metrics.UnitByte, p.GetPredictorName(), float64(p.reclaimable.Memory().Value()))
...
func (n *priorityReclaimablePredictor) GetResult() (v1.ResourceList, error) {
	...
	over_metrics.RecordNodePredictedResourceReclaimable(string(v1.ResourceCPU), over_metrics.UnitCore, n.GetPredictorName(), float64(reclaimable.Cpu().MilliValue())/1000)
	over_metrics.RecordNodePredictedResourceReclaimable(string(v1.ResourceMemory), over_metrics.UnitByte, n.GetPredictorName(), float64(reclaimable.Memory().Value()))
...
func (m *minPredictor) GetResult() (v1.ResourceList, error) {
	...
	over_metrics.RecordNodePredictedResourceReclaimable(string(v1.ResourceCPU), over_metrics.UnitCore, m.GetPredictorName(), float64(minimal.Cpu().MilliValue())/1000)
	over_metrics.RecordNodePredictedResourceReclaimable(string(v1.ResourceMemory), over_metrics.UnitByte, m.GetPredictorName(), float64(minimal.Memory().Value()))
	return minimal, nil
}
