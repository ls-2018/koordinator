...
func (p *plugin) ruleUpdateCbForNodeSLO(target *over_statesinformer.CallbackTarget) error {
	if target == nil {
...
func (p *plugin) ruleUpdateCbForNodeMeta(target *over_statesinformer.CallbackTarget) error {
	if target == nil {
		klog.Warningf("callback target is nil")
		return nil
	}
