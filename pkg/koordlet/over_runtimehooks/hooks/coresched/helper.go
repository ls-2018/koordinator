...
func (p *Plugin) getSandboxContainerPIDs(podMeta *over_statesinformer.PodMeta) ([]uint32, string, error) {
...
func (p *Plugin) getNormalContainerPIDs(podMeta *over_statesinformer.PodMeta, containerStatus *corev1.ContainerStatus) ([]uint32, error) {
	var pids []uint32
...
func (p *Plugin) getAllContainerPIDs(podMeta *over_statesinformer.PodMeta) []*containerPID {
...
func recordContainerCookieMetrics(containerCtx *protocol.ContainerContext, groupID string, cookieID uint64) {
	over_metrics.RecordContainerCoreSchedCookie(containerCtx.Request.PodMeta.Namespace,
		...
		groupID, cookieID)
	over_metrics.RecordCoreSchedCookieManageStatus(groupID, true)
}

func resetContainerCookieMetrics(containerCtx *protocol.ContainerContext, groupID string, lastCookieID uint64) {
	over_metrics.ResetContainerCoreSchedCookie(containerCtx.Request.PodMeta.Namespace,
		containerCtx.Request.PodMeta.Name, containerCtx.Request.PodMeta.UID,
		containerCtx.Request.ContainerMeta.Name, containerCtx.Request.ContainerMeta.ID,
