...
type Filter interface {
	Name() string
	Filter(podMeta *over_statesinformer.PodMeta) string
}
...
func (d *noneFilter) Filter(podMeta *over_statesinformer.PodMeta) string {
...
func (p *podQOSFilter) Filter(podMeta *over_statesinformer.PodMeta) string {
...
func NewReconciler(ctx Context) Reconciler {
	...
	ctx.StatesInformer.RegisterCallbacks(over_statesinformer.RegisterTypeAllPods, "runtime-hooks-reconciler", "Reconcile cgroup files if pod updated", r.podRefreshCallback)
	return r
}

type reconciler struct {
	podsMutex         sync.RWMutex
	podsMeta          []*over_statesinformer.PodMeta
...
func (c *reconciler) podRefreshCallback(t over_statesinformer.RegisterType, o interface{}, target *over_statesinformer.CallbackTarget) {
	if target == nil {
...
func (c *reconciler) getPodsMeta() []*over_statesinformer.PodMeta {
	c.podsMutex.RLock()
	defer c.podsMutex.RUnlock()
	result := make([]*over_statesinformer.PodMeta, len(c.podsMeta))
